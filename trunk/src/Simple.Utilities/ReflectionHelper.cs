...
namespace Simple.Utilities
{
    ...
    public static class ReflectionHelper
    {
        ...
        {
            Requires.ArgumentNotNull(instance, "instance");
        ...
        {
            Requires.ArgumentNotNull(types, "types");
        ...
        {
            return GetDefinedAttribute<T>(member, true);
        }
        ...
        public static object GetPropertyValue(object instance, string name)
        {
            ...
            if (property == null)
            {
                throw new ArgumentException("Type '{0}' does not contain property '{1}'.".ParseTemplate(type.Name, name));
            }
